...
using QrLinkki.Infrastructure.Persistence;

namespace QrLinkki.Infrastructure.Repository;

public class LinkRepository : ILinkRepository
{
    private readonly QrLinkki.Infrastructure.Persistence.AppDbContext _appDbContext;

    public LinkRepository(QrLinkki.Infrastructure.Persistence.AppDbContext appDbContext)
    {
